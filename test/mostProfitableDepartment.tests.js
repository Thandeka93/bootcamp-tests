describe('Testing mostProfitableDepartment', function () {
    it("should return outdoor is the most profitable department", function () {
        var salesData = [
    ...
    it("should return electronics is the  most profitable department", function () {
        var salesData2 = [
    ...
    it("should return hardware is the  most profitable department", function () {
        var salesData3 = [
            { department: 'electronics', sales: 4500, day: 'Monday' },
            { department: 'outdoor', sales: 1500, day: 'Monday' },
            { department: 'carpentry', sales: 5500, day: 'Monday' },
            ...
            { department: 'outdoor', sales: 8507, day: 'Wednesday' },
            { department: 'carpentry', sales: 8009, day: 'Wednesday' },
            { department: 'hardware', sales: 50000, day: 'Thursday' },
            { department: 'carpentry', sales: 6109, day: 'Thursday' },
            { department: 'hardware', sales: 7005, day: 'Friday' },
            { department: 'electronics', sales: 12006, day: 'Friday' },
            { department: 'electronics', sales: 16109, day: 'Saturday' },
        ...
        assert.equal('hardware', mostProfitableDepartment(salesData3), "Most profitable department is 'hardware' for dataset 3");
    });
